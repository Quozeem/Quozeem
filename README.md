...
Quozeem is a Software Full-Stack developer with the use of sophisticated programming languages,Strongly familiar with AWS lambda via Laravel Vapor serverless  ,also API's integration. He’s prolific and always willing to learn, have really worked on some projects that has been of great advantage to my skills and improved my knowledge, Not only my improvements to the computer programming languages ⚡.
...
I have learned web-development and having knowledge in HTML5,CSS3/Sass,Javascript,Jquery,PHP /Laravel,Typescript and ReactJs.
...
<a href="https://mobile.twitter.com/itech_icode">
